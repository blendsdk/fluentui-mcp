...
| Task | Recipe | Group |
| --- | --- | --- |
| Form Validation | [form-validation](recipes/forms/form-validation.md) | forms |
| Login Form | [login-form](recipes/forms/login-form.md) | forms |
| Multi-Step Form | [multi-step-form](recipes/forms/multi-step-form.md) | forms |
| Settings Form | [settings-form](recipes/forms/settings-form.md) | forms |
| Async Data States | [async-data-states](recipes/data/async-data-states.md) | data |
| Data Table | [data-table](recipes/data/data-table.md) | data |
| Virtualization | [virtualization](recipes/data/virtualization.md) | data |
| Application Navigation | [app-navigation](recipes/navigation/app-navigation.md) | navigation |
| Breadcrumb | [breadcrumb](recipes/navigation/breadcrumb.md) | navigation |
| Pagination | [pagination](recipes/navigation/pagination.md) | navigation |
| Tabs | [tabs](recipes/navigation/tabs.md) | navigation |
| Confirm Dialog | [confirm-dialog](recipes/modals/confirm-dialog.md) | modals |
| Drawer | [drawer](recipes/modals/drawer.md) | modals |
| Form Dialog | [form-dialog](recipes/modals/form-dialog.md) | modals |
| Dashboard Shell | [dashboard-shell](recipes/layout/dashboard-shell.md) | layout |
| Responsive Layout | [responsive-layout](recipes/layout/responsive-layout.md) | layout |
| Controlled vs Uncontrolled | [controlled-uncontrolled](recipes/state/controlled-uncontrolled.md) | state |
| Server State | [server-state](recipes/state/server-state.md) | state |
| Accessibility Basics | [accessibility-basics](recipes/accessibility/accessibility-basics.md) | accessibility |

## Categories

| Category | Components |
| --- | --- |
| [buttons](categories/buttons.md) | 5 |
| [forms](categories/forms.md) | 39 |
| [navigation](categories/navigation.md) | 36 |
| [data-display](categories/data-display.md) | 42 |
| [feedback](categories/feedback.md) | 21 |
| [overlays](categories/overlays.md) | 24 |
| [layout](categories/layout.md) | 5 |
| [utilities](categories/utilities.md) | 26 |

## Foundation

- [Getting Started with FluentUI](foundation/getting-started.md)
- [FluentProvider Setup](foundation/fluent-provider.md)
- [Theming System](foundation/theming.md)
- [Styling with Griffel](foundation/styling-griffel.md)
- [Component Architecture](foundation/component-architecture.md)
- [Accessibility Guide](foundation/accessibility.md)
...
- [Setup & Imports Cheatsheet](quick-reference/setup-imports.md)
- [Component Quick Reference](quick-reference/component-cheatsheet.md)
- [Styling Tokens Reference](quick-reference/styling-tokens.md)
- [Common Patterns Cheatsheet](quick-reference/common-patterns.md)
- [Accessibility Checklist](quick-reference/accessibility-checklist.md)
