...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"FluentUI MCP — Technical Docs","description":"Architecture documentation for fluentui-mcp: an MCP server serving FluentUI v9 documentation to AI agents.","base":"/fluentui-mcp/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Architecture","link":"/architecture/system-overview"},{"text":"Decisions","link":"/decisions/"},{"text":"Guides","link":"/guides/getting-started"},{"text":"Reference","link":"/reference/configuration"}],"sidebar":[{"text":"Overview","items":[{"text":"Introduction","link":"/"}]},{"text":"Architecture","items":[{"text":"System Overview","link":"/architecture/system-overview"},{"text":"API Design (MCP Tools)","link":"/architecture/api-design"}]},{"text":"Decisions","items":[{"text":"Decision Log","link":"/decisions/"},{"text":"ADR-001: Schema as Source of Truth","link":"/decisions/ADR-001-schema-as-source-of-truth"},{"text":"ADR-002: Bundled Enhanced JSON","link":"/decisions/ADR-002-bundled-enhanced-json"},{"text":"ADR-003: LLM Provider Model-Family Handling","link":"/decisions/ADR-003-llm-provider-model-family"},{"text":"ADR-004: TF-IDF In-Memory Search","link":"/decisions/ADR-004-tfidf-in-memory-search"}]},{"text":"Developer Guides","items":[{"text":"Getting Started","link":"/guides/getting-started"},{"text":"Development Workflow","link":"/guides/development"}]},{"text":"Reference","items":[{"text":"Configuration","link":"/reference/configuration"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/blendsdk/fluentui-mcp"}],"editLink":{"pattern":"https://github.com/blendsdk/fluentui-mcp/edit/main/techdocs/:path","text":"Edit this page on GitHub"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
